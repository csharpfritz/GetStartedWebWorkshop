# Module 11: Intelligent Image Analysis with AI

[← Previous Module](10-nservicebus.md) | [Back to README](../README.md)

In this module, you'll add a **second console application** to the `MyCollection` solution. This new project is another **NServiceBus endpoint**, and its job is different from the thumbnail worker you built in Module 10.
...
2. The Module 10 worker creates a thumbnail and converts the image to WebP
...
They can fail.
They can be retried.
They belong naturally in the same message-driven architecture you introduced in Module 10.
...
- `MyCollection.Messages` so it can handle the shared NServiceBus event contracts from Module 10
...
> If your shared contracts project from Module 10 has a different name, use that project instead. The important part is that both workers and the web app share the same message contract types.
...
You turned the AI analysis step into a proper message-driven contract. That keeps the solution extensible and preserves the event-based style introduced in Module 10.
...
public sealed class GenerateThumbnailHandler : IHandleMessages<ProcessCollectionImage>
{
    ...
    {
        // Module 10 implementation goes here.
...
You've completed the final module of the workshop. Your `MyCollection` app now uploads photos, generates thumbnails, analyzes images with AI, exports PDF reports, and displays the results — all orchestrated through NServiceBus and observable through Aspire. Great work! 🎉

# Module 9: Background Processing with NServiceBus
...
Right now, the photo upload flow from Module 8 is simple and direct:
...
- You already understand the upload flow from Module 8
